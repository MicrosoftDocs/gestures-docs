...
> [!TIP]
> Take a look at the **Console** window of the Unity editor. You will find various messages, warnings and errors there, generated by both our code and the Unity IDE (integrated development environment).
