...
1. Select the **GestureTrigger** game object in the **Hierarchy** window, and turn to the **Inspector** window:
    ...
    1. Specify which method is to be executed when the gesture is detected.
    1. Specify which method is to be executed when a certain [state in the gesture state-machine](index.md#gesture) is identified.
